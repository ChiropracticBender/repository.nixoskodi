...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Digi[/B][/COLOR]Wizard'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Digi[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOID = 'repository.nixoskodi'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/chiropracticbender/repository.nixoskodi/main/repo/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://chiropracticbender.github.io/repository.nixoskodi/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Digi[/B][/COLOR]Wizard'
